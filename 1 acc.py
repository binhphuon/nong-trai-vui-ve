...
def main():
    ...
    chosen_index = int(input("Chọn số thứ tự tài khoản muốn chạy trước: ")) - 1
    chosen_account = loadedAccounts.pop(chosen_index)
    loadedAccounts.insert(0, chosen_account)
...
def setupAccounts() -> list:
    ...
    for index, account in enumerate(loadedAccounts, start=1):
